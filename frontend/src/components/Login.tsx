...
export default function Login({ error }: { error: string | undefined }) {
    ...
    return (
        <form className="mt-[6%] mx-[5%] h-auto w-[50%] flex flex-col" onSubmit={onSubmit}>
            ...
            <input required className="h-12 w-[80%] mt-10 mb-8 border border-slate-500 p-2 font-sans text-white" placeholder="Email" type="text"
                onChange={(e) => { username.current = e.target.value }} />
            <input required className="h-12 w-[80%] mb-16 border border-slate-500 p-2 font-sans text-white" placeholder="Password" type="password"
